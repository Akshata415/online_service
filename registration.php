...
<body>
	...
	<div class="contact-box">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
      <table cellpadding="10" cellspacing="12" text-align="left	">
 ...
 <td> <input type="email" name="email" value="" placeholder="Enter Your Email Address" required="" style="padding: 10px; width: 300%">  <br> </td>
      ...
      <tr>   
<td text-align="center"> <input type="submit" name="sb" value="Register Now" style="color:red; background: lightgreen; font-size: 1.3em; font-family: times new roman">  <br> </td>
   </tr>
					...
					if(isset($_POST['sb']))
					{
						...
						echo "<center>Registration SuccessFull ... Click to login</center>";
					...
					<center><a href="login.php"><b><u>login<u><b></a><center>
