...
if(isset($_SESSION['uid']))
{
	...
	$em = $_POST['em'];
	$ad = $_POST['ad'];
	$s= mysqli_query($con,"select * from addlist where u_id='$uid'");
...
?>
	...
	<div style="background-color: #3b0878; font-size:1.4em; color: #b7e352;">Order Place SuccessFully </div>
	<div style="color: #4d2e1f; font-size:1.4em;"> 
