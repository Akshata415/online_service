...
<body>
	...
	<form action="" method="post">
		...
		<table align="center" border="1" cellspacing="14" cellpadding="12" style="color: black" >
                ...
                <tr align="center">
                	<td colspan="4"> <input type="submit" name="sb" value="Add List Now"></td>
                </tr>
		</table>
	</form>
			<?php
			if(isset($_POST['sb']))
			{
				...
				include "connect.php";
				mysqli_query($con,"insert into addlist(p_id,u_id,price,qty,total ) values('$pid','$uid','$price','$qty','$total')") or die(mysqli_error($con));
				echo "<script>alert('Your data Is Added')</script>";
